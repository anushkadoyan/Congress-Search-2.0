...
$legislators = request("http://104.198.0.197:8080/legislators?per_page=all&fields=party,first_name,last_name,chamber,district,state&apikey=9d713eee2bda4febb053035ef76e5f4c");
$committees = request("http://104.198.0.197:8080/committees?per_page=all&fields=chamber,committee_id,name,parent_committee_id,phone&apikey=9d713eee2bda4febb053035ef76e5f4c");
//&fields=bill_id,bill_type,chamber,introduced_on,official_title,sponsor
$billsOld = request("http://104.198.0.197:8080/bills?per_page=50&history.active=true&fields=bill_id,bill_type,chamber,introduced_on,official_title,sponsor&apikey=9d713eee2bda4febb053035ef76e5f4c");
$billsNew = request("http://104.198.0.197:8080/bills?per_page=50&history.active=false&fields=bill_id,bill_type,chamber,introduced_on,official_title,sponsor&apikey=9d713eee2bda4febb053035ef76e5f4c");
